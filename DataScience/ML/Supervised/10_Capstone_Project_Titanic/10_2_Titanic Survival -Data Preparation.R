...
dim(train)
dim(test)   ##  Survvied feature ahs been added in First Prediction Process
...
sum(is.na(Full$Age))
##or you can impute the NA age based on the mean of Pclass grouping. 
